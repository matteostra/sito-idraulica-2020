			...
			<footer id="site-footer" role="contentinfo">
				...
				<div class="footer-inner section-inner<?php echo esc_attr( $footer_inner_classes ); ?>">
					...
					<div class="footer-credits">
						...
						<p class="footer-copyright">&copy; <?php echo esc_html( date_i18n( __( 'Y', 'chaplin-child' ) ) ); ?> <a href="<?php echo esc_url( home_url() ); ?>" rel="home"><?php echo bloginfo( 'name' ); ?></a></p>

						<p class="theme-credits color-secondary">
							<?php
							/* Translators: $s = name of the theme developer */
							printf( esc_html_x( 'Disegnato da %s', 'Translators: $s = name of the theme developer', 'chaplin-child' ), '<a href="https://www.matteostraccia.com">' . esc_html__( 'Mattestra', 'chaplin-child' ) . '</a>' ); ?>
						</p><!-- .theme-credits -->
